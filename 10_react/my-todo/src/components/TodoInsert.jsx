...
// Tip: as를 사용하여 별칭을 붙여 사용하면 추후 아이콘을 바꿀 때 한곳만 바꾸면 돼서 편함!
...
const StyledButton = styled.button `
  ...
  align-items: center;
  cursor: pointer;
  transition: 0ms.2s background ease-in;
...
function TodoInsert({onInsert}) {
  ...
  return (
    ...
    <TodoInsertWrapper onSubmit={handleSubmit}>
      <StyledInput type='text' value={value} onChange={handleChange} placeholder='할 일을 입력하세요.' />
