...
// 리액트(js)에서 이미지파일 import 하는 법 
import yonexImg from "../images/yonex.jpg";

// 서버에서 받아온 데이터라고 가정
import data from "../data.json";
import { useDispatch, useSelector } from 'react-redux';
import { getAllProducts, selectProductList, getMoreProducts, getMoreProductsAsync, selectStatus } from '../features/product/productSlice';
    ...
    <section>
      <Container>
        <Row>
          ...
          {/* Quiz:
          1) 반복적인 상품 아이템을 ProductListItem 컴포넌트화 시키기
          2) productList 배열을 반복하여 ProductListItem을 렌더링하기
          3) 상품정보글 props로 넘겨서 데이터 바인딩하기
           */}
      ...
      <Button variant='secondary' className='mb-4'
        onClick={() => {
          axios.get('https://my-json-server.typicode.com/ivorygolds2/db-shop/products')
          .then((response) => {
