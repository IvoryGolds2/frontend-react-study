...
// 파라미터 x는 숫자만 들어 올 수 있음
function multifly(x: number): number { // return 되는 값을 숫자 타입으로 제한
  return x * 2;
  // return x + '2';
};
multifly(100);
...
function hello(name?:string) {
  if(name) {
    ...
    console.log('이름이 없숩니당');
  }
}
console.log(hello('Ivory'));
...
console.log(stringLength('good good'));
